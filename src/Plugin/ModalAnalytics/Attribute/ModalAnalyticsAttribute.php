...
namespace Drupal\custom_plugin\Plugin\ModalAnalytics\Attribute;

use Drupal\Component\Plugin\Attribute\Plugin;
use Drupal\Core\StringTranslation\TranslatableMarkup;

/**
 * Defines a ModalAnalytics attribute for plugin discovery.
 */
#[\Attribute(\Attribute::TARGET_CLASS)]
class ModalAnalyticsAttribute extends Plugin {

  /**
   * Constructs a ModalAnalytics attribute.
   *
   * @param string $id
   *   The plugin ID.
