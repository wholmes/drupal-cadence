...
namespace Drupal\custom_plugin\Plugin\ModalFormProvider\Attribute;

use Drupal\Component\Plugin\Attribute\Plugin;
use Drupal\Core\StringTranslation\TranslatableMarkup;

/**
 * Defines a ModalFormProvider attribute for plugin discovery.
 */
#[\Attribute(\Attribute::TARGET_CLASS)]
class ModalFormProviderAttribute extends Plugin {

  /**
   * Constructs a ModalFormProvider attribute.
   *
   * @param string $id
   *   The plugin ID.
